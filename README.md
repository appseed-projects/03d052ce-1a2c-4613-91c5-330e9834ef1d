...
- Timestamp: `2022-06-11 05:33`
- Build ID: `03d052ce-1a2c-4613-91c5-330e9834ef1d`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/03d052ce-1a2c-4613-91c5-330e9834ef1d.git
$ cd 03d052ce-1a2c-4613-91c5-330e9834ef1d
```
